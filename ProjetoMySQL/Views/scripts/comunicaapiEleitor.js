...
function excluir(id) {
    ...
    $.ajax({
        type: 'DELETE',
        url: 'https://127.0.0.1/Eleitor/Excluir/',
...
function cadastrar() {
    ...
    if ($('#salvarBtn').html() == 'Editar'){
        metodo = 'PUT';
        endereco = 'https://127.0.0.1/Eleitor/Alterar';
        mensagem = "Eleitor alterado com sucesso!";
        valorId = formulario.idInput.value;
    }
    else{
        metodo = 'POST';
        endereco = 'https://127.0.0.1/Eleitor/Cadastrar';
...
function visualizar(id) {
    $.get('https://127.0.0.1/Eleitor/Visualizar?id='+id)
        .done(function(resposta) { 
