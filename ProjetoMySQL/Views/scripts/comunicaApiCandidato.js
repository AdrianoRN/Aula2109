...
function excluir(id) {
    ...
    $.ajax({
        type: 'DELETE',
        url: 'https://127.0.0.1/Candidato/Excluir/',
...
function cadastrar() {
    ...
    if ($('#salvarBtn').html() == 'Editar'){
        metodo = 'PUT';
        endereco = 'https://127.0.0.1/Candidato/Alterar';
        mensagem = "Candidato alterado com sucesso!";
        valorId = formulario.idInput.value;
    }
    else{
        metodo = 'POST';
        endereco = 'https://127.0.0.1/Candidato/Cadastrar';
...
function visualizar(id) {
    $.get('https://127.0.0.1/Candidato/Visualizar?id='+id)
        .done(function(resposta) { 
